define(['angular'],function(){
	...
	// upload controller
	module.controller('uploadCtrl',['$scope','httpService','$upload',function($scope,httpService,$upload){
		
		$scope.fnSelectFile = function($files){
			...
			var $files = $scope.files;
			 for (var i = 0; i < $files.length; i++) {    
			    	...
			    	$scope.upload = $upload.upload({
			    		url: 'api/image/save', //upload.php script, node.js route, or servlet url
			    		method: 'POST',
				        ...
				        //formDataAppender: function(formData, key, val){}
				    	  ...
				    	  console.log('percent: ' + parseInt(100.0 * evt.loaded / evt.total));
				    		  ...
				    		  function(data, status, headers, config) {        // file is uploaded successfully
